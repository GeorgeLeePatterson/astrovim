...
-- local alpha = function(opt)
--   return string.format("%x", math.floor(255 * opt or 0.8))
-- end
...
if vim.g.neovide then
  ...
  -- options.g.neovide_transparency = 0.0
  -- options.g.transparency = 0.99
  -- options.g.neovide_background_color = "#343434"
  --   .. alpha(options.g.transparency)
end
